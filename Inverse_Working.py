...
#gamma_2_AC = dde.Variable(10.0) # Heat equation 1D
gamma_2_AC = tf.Variable(10.0, dtype=tf.float32) # Heat equation 1D
...
data = np.loadtxt('/home/asfandyarkhan/PINN/data/data.txt')
...
while total_iterations < 150000:
                ...
                model.compile("adam", lr=1e-4, loss= 'MSE', loss_weights=Loss_Weights, external_trainable_variables=[gamma_2_AC])
...
# plt.plot(gamma_values_corrected, mse_error_list, '-o', label='MSE Error', color='green')
#plt.yscale('log')
